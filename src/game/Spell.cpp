...
void Spell::SetTargetMap(uint32 i,uint32 cur,UnitList& TagUnitMap)
{
    ...
    switch(cur)
    {
        ...
        case TARGET_ALL_RAID_AROUND_CASTER:
        {
            ...
            {
                if(m_caster->HasAura(31876) || m_caster->HasAura(31877) || m_caster->HasAura(31878))
...
SpellCastResult Spell::CheckItems()
{
    ...
    if(m_spellInfo->RequiresSpellFocus)
    {
        ...
        CellLock<GridReadGuard> cell_lock(cell, p);
        cell_lock->Visit(cell_lock, object_checker, *m_caster->GetMap(), *m_caster, sWorld.GetMaxVisibleDistanceForPlayer());
